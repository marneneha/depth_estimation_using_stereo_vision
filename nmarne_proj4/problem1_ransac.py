...
(Homography_matrix12, status) = cv.findHomography(points2, points1, cv.RANSAC)
(Homography_matrix21, status) = cv.findHomography(points1, points2, cv.RANSAC)
...
cv.imshow('img0', img1)
cv.imshow('img1', img2)
cv.imshow('image0', img1_rectified)
cv.imshow('image1', img2_rectified)
cv.waitKey(0)
